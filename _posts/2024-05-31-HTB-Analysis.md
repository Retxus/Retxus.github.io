...
![](/assets/img/HTB-Analysis/Analysis.png)
...
Primero vemos si tenemos conexión con la máquina y de paso gracias al `ttl` identificamos si ante el tipo de máquina que estamos, en `linux` este suele ser de 64 y en `windows` de 128.
