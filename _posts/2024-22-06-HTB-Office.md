...
![](/assets/img/HTB-Office/Office.png)
...
Primero vemos si tenemos conexión con la máquina y de paso gracias al `ttl` identificamos si ante el tipo de máquina que estámos, en `linux` este suele ser de 64 y en `windows` de 128.
...
Aquí generamos un archivo en formato grepeable y hacemos uso de la herramienta `extarctPorts` de <a href="https://s4vitar.github.io/">s4vitar</a>.
...
```bash
kerbrute userenum -t 100 diccionario.txt --dc 10.10.11.3 -d office.htb -t 100
```
